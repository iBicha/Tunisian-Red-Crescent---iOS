...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/BusyNavigationBar.framework"
  install_framework "Pods/Dollar.framework"
  install_framework "Pods/EZLoadingActivity.framework"
  ...
  install_framework "Pods/Kugel.framework"
  ...
  install_framework "Pods/Sugar.framework"
